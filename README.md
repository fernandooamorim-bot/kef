...
```text
assets/video/intro-casal-v3.mp4
```
...
```bash
ffmpeg -i Design/OBQH1913.mp4 -vf "scale='min(1280,iw)':-2" -c:v libx264 -crf 26 -preset slow -c:a aac -b:a 96k assets/video/intro-casal-v3.mp4

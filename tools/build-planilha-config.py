...
SHEETS = [
    ...
    },
    {
        ...
        "rows": [
            ...
            ["P-001", "Petiscos Gourmet da Tereza", "Porque a verdadeira dona da casa também merece participar.", "assets/images/gifts/custom/1.jpeg", 280, "TRUE", 1],
            ["P-002", "Afinação Matrimonial", "Contribuição para manter a sanfona afinada e o casamento também.", "assets/images/gifts/custom/2.jpeg", 300, "TRUE", 2],
            ["P-003", "Aulas de Paciência para Conviver com um Artista", "Investimento contínuo.", "assets/images/gifts/custom/3.jpeg", 400, "TRUE", 3],
            ["P-004", "Passagem para a Tereza também curtir a lua de mel", "Para ela entrar no clima da viagem junto com os noivos.", "assets/images/gifts/custom/4.jpeg", 450, "TRUE", 4],
            ["P-005", "Fundo para manter o estoque de whey e creatina do noivo", "Não é porque casou que vai sair de forma.", "assets/images/gifts/custom/5.jpeg", 500, "TRUE", 5],
            ["P-006", "Mini sanfona pro futuro Fernando Júnior", "Primeiro investimento musical da próxima geração.", "assets/images/gifts/custom/6.jpeg", 600, "TRUE", 6],
            ["P-007", "Um Dia de Lua de Mel Sem Pensar em Boletos", "Sonho patrocinado.", "assets/images/gifts/custom/7.jpeg", 700, "TRUE", 7],
            ["P-008", "Milhas para conseguir ter uma lua de mel em 2027", "Ajude os noivos a decolarem nessa próxima aventura.", "assets/images/gifts/custom/8.jpeg", 1000, "TRUE", 8],
            ["P-009", "Compensação por Horas de Plantão Perdidas Planejando Casamento", "Investimento na terapia.", "assets/images/gifts/custom/9.jpeg", 2000, "TRUE", 9],
            ["P-010", "Ajude em uma mesa de jantar 8 lugares pra você jantar conosco", "Um convite antecipado para muitos encontros no novo lar.", "assets/images/gifts/custom/10.jpeg", 5000, "TRUE", 10],
            ["P-011", "Mostre o quanto você é fã do noivo e invista na carreira dele", "Para a noiva não precisar mais pegar plantão.", "assets/images/gifts/custom/11.jpeg", 10000, "TRUE", 11],
        ],
        "widths": [14, 46, 74, 44, 16, 14, 14],
    },
    {
        "name": "OPERADORES",
        "rows": [

...
const sheets = [
  ...
  },
  {
    ...
    rows: [
      ...
      ["hero_video", "assets/video/intro-casal-v3.mp4", "Vídeo de fundo do topo/hero"],
  ...
  },
  {
    name: "PRESENTES",
    rows: [
      ["codigo_presente", "titulo", "descricao", "imagem", "posicao_imagem", "link_pagamento", "valor", "ativo", "ordem"],
      ["P-001", "Petiscos Gourmet da Tereza", "Porque a verdadeira dona da casa também merece participar.", "assets/images/gifts/custom/1.jpeg", "52% 58%", "https://pag.ae/81ZoZxg7K", 280, "TRUE", 1],
      ["P-002", "Afinação Matrimonial", "Contribuição para manter a sanfona afinada e o casamento também.", "assets/images/gifts/custom/2.jpeg", "50% 42%", "https://pag.ae/81Zo-ipHN", 300, "TRUE", 2],
      ["P-003", "Aulas de Paciência para Conviver com um Artista", "Investimento contínuo.", "assets/images/gifts/custom/3.jpeg", "50% 36%", "https://pag.ae/81Zo-R6cN", 400, "TRUE", 3],
      ["P-004", "Passagem para a Tereza também curtir a lua de mel", "Para ela entrar no clima da viagem junto com os noivos.", "assets/images/gifts/custom/4.jpeg", "50% 48%", "https://pag.ae/81Zo_LicK", 450, "TRUE", 4],
      ["P-005", "Fundo para manter o estoque de whey e creatina do noivo", "Não é porque casou que vai sair de forma.", "assets/images/gifts/custom/5.jpeg", "50% 40%", "https://pag.ae/81Zp1wGVs", 500, "TRUE", 5],
      ["P-006", "Mini sanfona pro futuro Fernando Júnior", "Primeiro investimento musical da próxima geração.", "assets/images/gifts/custom/6.jpeg", "50% 0%", "https://pag.ae/81Zp1Zyzs", 600, "TRUE", 6],
      ["P-007", "Um Dia de Lua de Mel Sem Pensar em Boletos", "Sonho patrocinado.", "assets/images/gifts/custom/7.jpeg", "50% 48%", "https://pag.ae/81Zp2eM64", 700, "TRUE", 7],
      ["P-008", "Milhas para conseguir ter uma lua de mel em 2027", "Ajude os noivos a decolarem nessa próxima aventura.", "assets/images/gifts/custom/8.jpeg", "50% 44%", "https://pag.ae/81Zp2zXNK", 1000, "TRUE", 8],
      ["P-009", "Compensação por Horas de Plantão Perdidas Planejando Casamento", "Investimento na terapia.", "assets/images/gifts/custom/9.jpeg", "50% 38%", "https://pag.ae/81Zp4c6TK", 2000, "TRUE", 9],
      ["P-010", "Ajude em uma mesa de jantar 8 lugares pra você jantar conosco", "Um convite antecipado para muitos encontros no novo lar.", "assets/images/gifts/custom/10.jpeg", "50% 46%", "https://pag.ae/81Zp4LoX7", 5000, "TRUE", 10],
      ["P-011", "Mostre o quanto você é fã do noivo e invista na carreira dele", "Para a noiva não precisar mais pegar plantão.", "assets/images/gifts/custom/11.jpeg", "50% 50%", "https://pag.ae/81Zp59c14", 10000, "TRUE", 11]
    ],
    widths: [14, 34, 68, 44, 18, 34, 16, 14, 14]
  },
  {

window.WEDDING_CONFIG = {
  ...
  fallbackData: {
    ...
    gifts: [
      ...
      { gift_id: "P-011", title: "Enxoval dos sonhos", description: "Lençóis, toalhas e conforto para a rotina ficar mais leve.", image: "assets/images/gifts/enxoval.svg", amount: 400, enabled: "TRUE", sort_order: 11 },
      { gift_id: "P-012", title: "Tete também casa", description: "Um mimo simbólico para nossa pequena participar desse momento.", image: "assets/images/gifts/tete.svg", amount: 150, enabled: "TRUE", sort_order: 12 },
      { gift_id: "P-013", title: "Domingo preguiçoso", description: "Delivery, filme e descanso para depois da maratona do casamento.", image: "assets/images/gifts/domingo.svg", amount: 190, enabled: "TRUE", sort_order: 13 },
      { gift_id: "P-014", title: "Álbum de memórias", description: "Para eternizar fotos e detalhes desse tempo tão especial.", image: "assets/images/gifts/memorias.svg", amount: 260, enabled: "TRUE", sort_order: 14 },
